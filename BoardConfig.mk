...
TARGET_RELEASETOOL_OTA_FROM_TARGET_SCRIPT := ./build/tools/releasetools/ota_from_target_files -e ./device/samsung/espressovzw/installer_extra

# Kernel
TARGET_KERNEL_CONFIG        := cyanogen_espressovzw_defconfig
BOARD_MKBOOTIMG_ARGS        := --ramdisk_offset 0x01500000
## one day it'll have 3.4 kernel merged in to d2
TARGET_KERNEL_SOURCE        := kernel/samsung/apex
